"""
Django settings for odd_union_dev_121460 project.
...
ROOT_URLCONF = 'odd_union_dev_121460.urls'
...
WSGI_APPLICATION = 'odd_union_dev_121460.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_union_dev_121460 API",
    "DESCRIPTION": "API documentation for odd_union_dev_121460 App",
    "VERSION": "v1",
}
